...
# n_fins_list = np.array([8,10,12,14,16,18])
# ambients = [5.4, 4.7, 3.8, 3.5, 3.3, 3.1]
n_fins_list = np.array([8])
ambients = [5.4]

for n_fins, ambient in zip(n_fins_list, ambients):
    
    path = '4_Fins_study_data'
    ...
    full_matrix_iteration_method(T_0_pr, T_0_cs, T_0_hs, T_0_fn, T_k_pr, T_k_cs, T_k_hs, T_k_fn, h, M_inv_pr, M_inv_cs, M_inv_hs, M_inv_fn, vol_pr, vol_cs, vol_sinc, vol_fins, path, title, iterations=75000)